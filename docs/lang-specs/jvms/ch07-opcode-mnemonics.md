...
This chapter gives the mapping from Java Virtual Machine instruction opcodes, including the reserved opcodes ([§6.2](ch06-instruction-set.md#jvms-6.2)), to the mnemonics for the instructions represented by those opcodes.
