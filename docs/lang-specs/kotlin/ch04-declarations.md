...
[4.1. Classifier declaration](ch04-declarations.md#kls-4.1)

[4.1.1. Class declaration](ch04-declarations.md#kls-4.1.1)

[4.1.2. Data class declaration](ch04-declarations.md#kls-4.1.2)

[4.1.3. Enum class declaration](ch04-declarations.md#kls-4.1.3)

[4.1.4. Annotation class declaration](ch04-declarations.md#kls-4.1.4)

[4.1.5. Value class declaration](ch04-declarations.md#kls-4.1.5)

[4.1.6. Interface declaration](ch04-declarations.md#kls-4.1.6)

[4.1.7. Object declaration](ch04-declarations.md#kls-4.1.7)

[4.1.8. Local class declaration](ch04-declarations.md#kls-4.1.8)

[4.1.9. Classifier initialization](ch04-declarations.md#kls-4.1.9)

[4.1.10. Classifier declaration scopes](ch04-declarations.md#kls-4.1.10)

[4.2. Function declaration](ch04-declarations.md#kls-4.2)

[4.2.1. Function signature](ch04-declarations.md#kls-4.2.1)

[4.2.2. Named, positional and default parameters](ch04-declarations.md#kls-4.2.2)

[4.2.3. Variable length parameters](ch04-declarations.md#kls-4.2.3)

[4.2.4. Extension function declaration](ch04-declarations.md#kls-4.2.4)

[4.2.5. Inlining](ch04-declarations.md#kls-4.2.5)

[4.2.6. Infix functions](ch04-declarations.md#kls-4.2.6)

[4.2.7. Local function declaration](ch04-declarations.md#kls-4.2.7)

[4.2.8. Tail recursion optimization](ch04-declarations.md#kls-4.2.8)

[4.2.9. Function declaration scopes](ch04-declarations.md#kls-4.2.9)

[4.3. Property declaration](ch04-declarations.md#kls-4.3)

[4.3.1. Read-only property declaration](ch04-declarations.md#kls-4.3.1)

[4.3.2. Mutable property declaration](ch04-declarations.md#kls-4.3.2)

[4.3.3. Local property declaration](ch04-declarations.md#kls-4.3.3)

[4.3.4. Getters and setters](ch04-declarations.md#kls-4.3.4)

[4.3.5. Delegated property declaration](ch04-declarations.md#kls-4.3.5)

[4.3.6. Extension property declaration](ch04-declarations.md#kls-4.3.6)

[4.3.7. Property initialization](ch04-declarations.md#kls-4.3.7)

[4.3.8. Constant properties](ch04-declarations.md#kls-4.3.8)

[4.3.9. Late-initialized properties](ch04-declarations.md#kls-4.3.9)

[4.3.10. Property declaration scopes](ch04-declarations.md#kls-4.3.10)

[4.4. Type alias](ch04-declarations.md#kls-4.4)

[4.5. Declarations with type parameters](ch04-declarations.md#kls-4.5)

[4.5.1. Type parameter variance](ch04-declarations.md#kls-4.5.1)

[4.5.2. Reified type parameters](ch04-declarations.md#kls-4.5.2)

[4.5.3. Underscore type arguments](ch04-declarations.md#kls-4.5.3)

[4.6. Declaration visibility](ch04-declarations.md#kls-4.6)
...
- Name c;
- Optional primary constructor declaration *ctor*;
- Optional supertype specifiers S_1, ..., S_s;
- Optional body b, which may include the following:
  - secondary constructor declarations *stor_1*, ..., *stor_c*;
  - instance initialization blocks *init_1*, ..., *init_i*;
  - property declarations *prop_1*, ..., *prop_p*;
  - function declarations *md_1*, ..., *md_m*;
  - companion object declaration *companionObj*;
  - nested classifier declarations *nested*.

and creates a simple classifier type c : S_1, ..., S_s.
...
A parameterized class declaration, in addition to what constitutes a simple class declaration, also has a type parameter list T_1, ..., T_m and extends the rules for a simple class declaration w.r.t. this type parameter list. Further details are described here.
...
A data class *dataClass* is a special kind of class, which represents a product type constructed from a number of data properties (dp_1, ..., dp_m), described in its primary constructor. Non-property constructor parameters are not allowed in the primary constructor of a data class. As such, data classes allow Kotlin to reduce the boilerplate and generate a number of additional data-relevant functions.
...
- Name f;
- Parameter list (p_1 : P_1[= v_1], ..., p_n : P_n[= v_n]);
- Return type R;
- Body b.

and has a function type f : (p_1 : P_1, ..., p_n : P_n) -> R.

Parameter list (p_1 : P_1[= v_1], ..., p_n : P_n[= v_n]) describes function parameters, i.e. inputs needed to execute the declared function. Each parameter p_i : P_i = v_i introduces p_i as a name of value with type P_i available inside function body b; therefore, parameters are final and cannot be changed inside the function. A function may have zero or more parameters.
...
- If function body b is present in the expression form and it may be inferred to have a valid type B : B is not equivalent to `kotlin.Nothing`, R is equivalent to B.
- If function body b is present in the block form, R is equivalent to `kotlin.Unit`.
...
- Name f;
- Type parameter list T_1, ..., T_m (if present);
- Parameter list P_1, ..., P_n.
...
If one wants to mix named and positional arguments, the argument list must conform to the following form: PoN_1, ..., PoN_M, N_1, ..., N_Q, where PoN_i is an i-th argument in either positional or named form, N_j is a named argument irregardless of its position.
...
A value of type Q <: ATS(`kotlin.Array(out P_i)`) may be *unpacked* to a variable length parameter in function invocation using spread operator; in this case array elements are considered to be separate arguments in the variable length parameter position.
...
- TG is equivalent to T;
- TS is equivalent to T;
- RT is equivalent to `kotlin.Unit`;
