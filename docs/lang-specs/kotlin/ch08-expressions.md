...
[8.1. Constant Literals](#kls-8.1)

[8.1.1. Boolean Literals](#kls-8.1.1)

[8.1.2. Integer Literals](#kls-8.1.2)

[8.1.3. The Types for Integer Literals](#kls-8.1.3)

[8.1.4. Real Literals](#kls-8.1.4)

[8.1.5. Character Literals](#kls-8.1.5)

[8.1.6. String Literals](#kls-8.1.6)

[8.1.7. Null Literal](#kls-8.1.7)

[8.2. Constant Expressions](#kls-8.2)

[8.3. String Interpolation Expressions](#kls-8.3)

[8.4. Try-expressions](#kls-8.4)

[8.5. Conditional Expressions](#kls-8.5)

[8.6. When Expressions](#kls-8.6)

[8.6.1. Exhaustive When Expressions](#kls-8.6.1)

[8.7. Logical Disjunction Expressions](#kls-8.7)

[8.8. Logical Conjunction Expressions](#kls-8.8)

[8.9. Equality Expressions](#kls-8.9)

[8.9.1. Reference Equality Expressions](#kls-8.9.1)

[8.9.2. Value Equality Expressions](#kls-8.9.2)

[8.10. Comparison Expressions](#kls-8.10)

[8.11. Type-checking and Containment-checking Expressions](#kls-8.11)

[8.11.1. Type-checking Expressions](#kls-8.11.1)

[8.11.2. Containment-checking Expressions](#kls-8.11.2)

[8.12. Elvis Operator Expressions](#kls-8.12)

[8.13. Range Expressions](#kls-8.13)

[8.14. Additive Expressions](#kls-8.14)

[8.15. Multiplicative Expressions](#kls-8.15)

[8.16. Cast Expressions](#kls-8.16)

[8.17. Prefix Expressions](#kls-8.17)

[8.17.1. Annotated Expressions](#kls-8.17.1)

[8.17.2. Prefix Increment Expressions](#kls-8.17.2)

[8.17.3. Prefix Decrement Expressions](#kls-8.17.3)

[8.17.4. Unary Minus Expressions](#kls-8.17.4)

[8.17.5. Unary Plus Expressions](#kls-8.17.5)

[8.17.6. Logical Not Expressions](#kls-8.17.6)

[8.18. Postfix Operator Expressions](#kls-8.18)

[8.18.1. Postfix Increment Expressions](#kls-8.18.1)

[8.18.2. Postfix Decrement Expressions](#kls-8.18.2)

[8.19. Not-null Assertion Expressions](#kls-8.19)

[8.20. Indexing Expressions](#kls-8.20)

[8.21. Call and Property Access Expressions](#kls-8.21)

[8.21.1. Navigation Operators](#kls-8.21.1)

[8.21.2. Callable References](#kls-8.21.2)

[8.21.3. Class Literals](#kls-8.21.3)

[8.21.4. Function Calls and Property Access](#kls-8.21.4)

[8.21.5. Spread Operator Expressions](#kls-8.21.5)

[8.22. Function Literals](#kls-8.22)

[8.22.1. Anonymous Function Declarations](#kls-8.22.1)

[8.22.2. Lambda Literals](#kls-8.22.2)

[8.23. Object Literals](#kls-8.23)

[8.23.1. Functional Interface Lambda Literals](#kls-8.23.1)

[8.24. This-expressions](#kls-8.24)

[8.25. Super-forms](#kls-8.25)

[8.26. Jump Expressions](#kls-8.26)

[8.26.1. Throw Expressions](#kls-8.26.1)

[8.26.2. Return Expressions](#kls-8.26.2)

[8.26.3. Continue Expressions](#kls-8.26.3)

[8.26.4. Break Expressions](#kls-8.26.4)
...
- It has a bound value and at least one of the following is true:
  ...
  - The bound expression is of a `sealed` class or interface S and all of its direct non-sealed subtypes T_1, ..., T_n are covered in this expression. A subtype T_i is considered covered if when expression contains one of the following:
    - a type test condition `is S_j`, where S_j <: S, T_i <: S_j;
    - a type test condition `!is S_j`, where S_j <: S, T_i is not a subtype of S_j, and there exists k != i such that T_k <: S_j.
...
1. For all A, B: `A === B` implies `A.equals(B)`
2. For all A, B: `B === null` implies `!A.equals(B)`
...
If the type *T* is not a parameterized type, it must be runtime-available, otherwise it is a compile-time error. If *T* is a parameterized type, the bare type argument inference is performed for the compile-time known type of *E* and the type constructor *TC* of *T*. After that, given the result type arguments of this bare type inference A_0, A_1 ... A_N, *T* must suffice the constraint T!! <: TC[A_0, A_1 ... A_N], checking each of its argument for conformance with the type of *E*.
...
*T* may also be specified without arguments by using the *bare type syntax* in which case the same process of bare type argument inference is performed, with the difference being that the resulting arguments A_0, A_1 ... A_N are used as arguments for *T* directly. If any of these arguments are inferred to be star-projections, this is a compile-time error.
