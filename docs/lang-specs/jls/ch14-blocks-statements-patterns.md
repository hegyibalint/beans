...
[14.1. Normal and Abrupt Completion of Statements](ch14-blocks-statements-patterns.md#jls-14.1)

[14.2. Blocks](ch14-blocks-statements-patterns.md#jls-14.2)

[14.3. Local Class and Interface Declarations](ch14-blocks-statements-patterns.md#jls-14.3)

[14.4. Local Variable Declarations](ch14-blocks-statements-patterns.md#jls-14.4)

[14.4.1. Local Variable Declarators and Types](ch14-blocks-statements-patterns.md#jls-14.4.1)

[14.4.2. Local Variable Declaration Statements](ch14-blocks-statements-patterns.md#jls-14.4.2)

[14.5. Statements](ch14-blocks-statements-patterns.md#jls-14.5)

[14.6. The Empty Statement](ch14-blocks-statements-patterns.md#jls-14.6)

[14.7. Labeled Statements](ch14-blocks-statements-patterns.md#jls-14.7)

[14.8. Expression Statements](ch14-blocks-statements-patterns.md#jls-14.8)

[14.9. The `if` Statement](ch14-blocks-statements-patterns.md#jls-14.9)

[14.9.1. The `if`-`then` Statement](ch14-blocks-statements-patterns.md#jls-14.9.1)

[14.9.2. The `if`-`then`-`else` Statement](ch14-blocks-statements-patterns.md#jls-14.9.2)

[14.10. The `assert` Statement](ch14-blocks-statements-patterns.md#jls-14.10)

[14.11. The `switch` Statement](ch14-blocks-statements-patterns.md#jls-14.11)

[14.11.1. Switch Blocks](ch14-blocks-statements-patterns.md#jls-14.11.1)

[14.11.1.1. Exhaustive Switch Blocks](ch14-blocks-statements-patterns.md#jls-14.11.1.1)

[14.11.1.2. Determining which Switch Label Applies at Run Time](ch14-blocks-statements-patterns.md#jls-14.11.1.2)

[14.11.2. The Switch Block of a `switch` Statement](ch14-blocks-statements-patterns.md#jls-14.11.2)

[14.11.3. Execution of a `switch` Statement](ch14-blocks-statements-patterns.md#jls-14.11.3)

[14.12. The `while` Statement](ch14-blocks-statements-patterns.md#jls-14.12)

[14.12.1. Abrupt Completion of `while` Statement](ch14-blocks-statements-patterns.md#jls-14.12.1)

[14.13. The `do` Statement](ch14-blocks-statements-patterns.md#jls-14.13)

[14.13.1. Abrupt Completion of `do` Statement](ch14-blocks-statements-patterns.md#jls-14.13.1)

[14.14. The `for` Statement](ch14-blocks-statements-patterns.md#jls-14.14)

[14.14.1. The basic `for` Statement](ch14-blocks-statements-patterns.md#jls-14.14.1)

[14.14.1.1. Initialization of `for` Statement](ch14-blocks-statements-patterns.md#jls-14.14.1.1)

[14.14.1.2. Iteration of `for` Statement](ch14-blocks-statements-patterns.md#jls-14.14.1.2)

[14.14.1.3. Abrupt Completion of `for` Statement](ch14-blocks-statements-patterns.md#jls-14.14.1.3)

[14.14.2. The enhanced `for` statement](ch14-blocks-statements-patterns.md#jls-14.14.2)

[14.15. The `break` Statement](ch14-blocks-statements-patterns.md#jls-14.15)

[14.16. The `continue` Statement](ch14-blocks-statements-patterns.md#jls-14.16)

[14.17. The `return` Statement](ch14-blocks-statements-patterns.md#jls-14.17)

[14.18. The `throw` Statement](ch14-blocks-statements-patterns.md#jls-14.18)

[14.19. The `synchronized` Statement](ch14-blocks-statements-patterns.md#jls-14.19)

[14.20. The `try` statement](ch14-blocks-statements-patterns.md#jls-14.20)

[14.20.1. Execution of `try`-`catch`](ch14-blocks-statements-patterns.md#jls-14.20.1)

[14.20.2. Execution of `try`-`finally` and `try`-`catch`-`finally`](ch14-blocks-statements-patterns.md#jls-14.20.2)

[14.20.3. `try`-with-resources](ch14-blocks-statements-patterns.md#jls-14.20.3)

[14.20.3.1. Basic `try`-with-resources](ch14-blocks-statements-patterns.md#jls-14.20.3.1)

[14.20.3.2. Extended `try`-with-resources](ch14-blocks-statements-patterns.md#jls-14.20.3.2)

[14.21. The `yield` Statement](ch14-blocks-statements-patterns.md#jls-14.21)

[14.22. Unreachable Statements](ch14-blocks-statements-patterns.md#jls-14.22)

[14.30. Patterns](ch14-blocks-statements-patterns.md#jls-14.30)

[14.30.1. Kinds of Patterns](ch14-blocks-statements-patterns.md#jls-14.30.1)

[14.30.2. Pattern Matching](ch14-blocks-statements-patterns.md#jls-14.30.2)

[14.30.3. Properties of Patterns](ch14-blocks-statements-patterns.md#jls-14.30.3)
...
- The `break`, `yield`, `continue`, and `return` statements ([§14.15](ch14-blocks-statements-patterns.md#jls-14.15), [§14.21](ch14-blocks-statements-patterns.md#jls-14.21), [§14.16](ch14-blocks-statements-patterns.md#jls-14.16), [§14.17](ch14-blocks-statements-patterns.md#jls-14.17)) cause a transfer of control that may prevent normal completion of expressions, statements, and blocks that contain them.

- Evaluation of certain expressions may throw exceptions from the Java Virtual Machine ([§15.6](ch15-expressions.md#jls-15.6)). An explicit `throw` ([§14.18](ch14-blocks-statements-patterns.md#jls-14.18)) statement also results in an exception. An exception causes a transfer of control that may prevent normal completion of statements.
...
The terms "complete normally" and "complete abruptly" also apply to the evaluation of expressions ([§15.6](ch15-expressions.md#jls-15.6)). The only reason an expression can complete abruptly is that an exception is thrown, because of either a `throw` with a given value ([§14.18](ch14-blocks-statements-patterns.md#jls-14.18)) or a run-time exception or error ([§11 (Exceptions)](ch11-exceptions.md), [§15.6](ch15-expressions.md#jls-15.6)).
...
A *local class* is a nested class ([§8 (Classes)](ch08-classes.md)) whose declaration is immediately contained by a block ([§14.2](ch14-blocks-statements-patterns.md#jls-14.2)).

A *local interface* is a nested interface ([§9 (Interfaces)](ch09-interfaces.md)) whose declaration is immediately contained by a block.
...
It is a compile-time error if a local class or interface declaration has any of the access modifiers `public`, `protected`, or `private` ([§6.6](ch06-names.md#jls-6.6)).

It is a compile-time error if a local class or interface declaration has the modifier `static` ([§8.1.1.4](ch08-classes.md#jls-8.1.1.4)), `sealed`, or `non-sealed` ([§8.1.1.2](ch08-classes.md#jls-8.1.1.2), [§9.1.1.4](ch09-interfaces.md#jls-9.1.1.4)).
...
A local class may be a normal class ([§8.1](ch08-classes.md#jls-8.1)), an enum class ([§8.9](ch08-classes.md#jls-8.9)), or a record class ([§8.10](ch08-classes.md#jls-8.10)). Every local normal class is an inner class ([§8.1.3](ch08-classes.md#jls-8.1.3)). Every local enum class and local record class is implicitly `static` ([§8.1.1.4](ch08-classes.md#jls-8.1.1.4)), and therefore not an inner class.

A local interface may be a normal interface ([§9.1](ch09-interfaces.md#jls-9.1)), but not an annotation interface ([§9.6](ch09-interfaces.md#jls-9.6)). Every local interface is implicitly `static` ([§9.1.1.3](ch09-interfaces.md#jls-9.1.1.3)).

Like an anonymous class ([§15.9.5](ch15-expressions.md#jls-15.9.5)), a local class or interface is not a member of any package, class, or interface ([§7.1](ch07-packages-modules.md#jls-7.1), [§8.5](ch08-classes.md#jls-8.5)). Unlike an anonymous class, a local class or interface has a simple name ([§6.2](ch06-names.md#jls-6.2), [§6.7](ch06-names.md#jls-6.7)).

The scope and shadowing of a local class or interface declaration is specified in [§6.3](ch06-names.md#jls-6.3) and [§6.4](ch06-names.md#jls-6.4).
...
A *local variable declaration* declares and optionally initializes one or more local variables ([§4.12.3](ch04-types-values-variables.md#jls-4.12.3)).
...
See [§8.3](ch08-classes.md#jls-8.3) for *UnannType*. The following productions from [§4.3](ch04-types-values-variables.md#jls-4.3), [§8.3](ch08-classes.md#jls-8.3), and [§8.4.1](ch08-classes.md#jls-8.4.1) are shown here for convenience:
...
- a local variable declaration statement in a block ([§14.4.2](ch14-blocks-statements-patterns.md#jls-14.4.2))

- the header of a basic `for` statement ([§14.14.1](ch14-blocks-statements-patterns.md#jls-14.14.1))

- the header of an enhanced `for` statement ([§14.14.2](ch14-blocks-statements-patterns.md#jls-14.14.2))

- the resource specification of a `try`-with-resources statement ([§14.20.3](ch14-blocks-statements-patterns.md#jls-14.20.3))

- a pattern ([§14.30.1](ch14-blocks-statements-patterns.md#jls-14.30.1))


The rules concerning annotation modifiers for a local variable declaration are specified in [§9.7.4](ch09-interfaces.md#jls-9.7.4) and [§9.7.5](ch09-interfaces.md#jls-9.7.5).

If the keyword `final` appears as a modifier for a local variable declaration, then the local variable is a `final` variable ([§4.12.4](ch04-types-values-variables.md#jls-4.12.4)).
...
Each *declarator* in a local variable declaration declares one local variable. If the declarator includes an *Identifier* then this is the name of the local variable, otherwise the local variable is unnamed ([§6.1](ch06-names.md#jls-6.1)).

If the optional keyword `final` appears at the start of the declaration, the variable being declared is a final variable ([§4.12.4](ch04-types-values-variables.md#jls-4.12.4)).
...
- If the *LocalVariableType* is *UnannType*, and bracket pairs appear in *UnannType* or *VariableDeclaratorId*, then the type of the local variable is specified by [§10.2](ch10-arrays.md#jls-10.2).

- If the *LocalVariableType* is `var`, then let T be the type of the initializer expression when treated as if it did not appear in an assignment context, and were thus a standalone expression ([§15.2](ch15-expressions.md#jls-15.2)). The type of the local variable is the upward projection of T with respect to all synthetic type variables mentioned by T ([§4.10.5](ch04-types-values-variables.md#jls-4.10.5)).

  It is a compile-time error if T is the null type.

  Because the initializer is treated as if it did not appear in an assignment context, an error occurs if it is a lambda expression ([§15.27](ch15-expressions.md#jls-15.27)) or a method reference expression ([§15.13](ch15-expressions.md#jls-15.13)).


The scope and shadowing of a local variable declaration is specified in [§6.3](ch06-names.md#jls-6.3) and [§6.4](ch06-names.md#jls-6.4).

References to a local variable from a nested class or interface, or a lambda expression, are restricted, as specified in [§6.5.6.1](ch06-names.md#jls-6.5.6.1).
...
Every local variable declaration statement is immediately contained by a block, whereas other kinds of statement ([§14.5](ch14-blocks-statements-patterns.md#jls-14.5)) may be immediately contained by either a block or another statement.
...
If a declarator does not have an initializer, then every reference to the variable must be preceded by execution of an assignment to the variable, or a compile-time error occurs by the rules of [§16 (Definite Assignment)](ch16-definite-assignment.md).
...
The following productions from [§14.9](ch14-blocks-statements-patterns.md#jls-14.9) are shown here for convenience:
...
Unlike C and C++, the Java programming language has no `goto` statement; identifier statement labels are used with `break` or `continue` statements ([§14.15](ch14-blocks-statements-patterns.md#jls-14.15), [§14.16](ch14-blocks-statements-patterns.md#jls-14.16)) appearing anywhere within the labeled statement.
...
There is no restriction against using the same identifier as a label and as the name of a package, class, interface, method, field, parameter, or local variable. Use of an identifier to label a statement does not obscure ([§6.4.2](ch06-names.md#jls-6.4.2)) a package, class, interface, method, field, parameter, or local variable with the same name. Use of an identifier as a class, interface, method, field, local variable or as the parameter of an exception handler ([§14.20](ch14-blocks-statements-patterns.md#jls-14.20)) does not obscure a statement label with the same name.
...
Unlike C and C++, the Java programming language allows only certain forms of expressions to be used as expression statements. For example, it is legal to use a method invocation expression ([§15.12](ch15-expressions.md#jls-15.12)):
...
but it is not legal to use a parenthesized expression ([§15.8.5](ch15-expressions.md#jls-15.8.5)):
...
An `if`-`then` statement is executed by first evaluating the *Expression*. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
An `if`-`then`-`else` statement is executed by first evaluating the *Expression*. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
It is a compile-time error if, in the second form of the `assert` statement, *Expression2* is void ([§15.1](ch15-expressions.md#jls-15.1)).
...
An enabled `assert` statement is executed by first evaluating *Expression1*. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
The body of both a `switch` statement and a `switch` expression ([§15.28](ch15-expressions.md#jls-15.28)) is called a *switch block*. This subsection presents general rules which apply to all switch blocks, whether they appear in `switch` statements or `switch` expressions. Other subsections present additional rules which apply either to switch blocks in `switch` statements ([§14.11.2](ch14-blocks-statements-patterns.md#jls-14.11.2)) or to switch blocks in `switch` expressions ([§15.28.1](ch15-expressions.md#jls-15.28.1)).
...
Every `case` constant must be either a constant expression ([§15.29](ch15-expressions.md#jls-15.29)), or the name of an enum constant ([§8.9.1](ch08-classes.md#jls-8.9.1)), otherwise a compile-time error occurs.

A `case` label with a `null` literal may have an optional `default`.

A `case` label with `case` patterns may have an optional `when` expression, known as a *guard*, which represents a further test on values that match the patterns. A `case` label is said to be *unguarded* if either (i) it has no guard, or (ii) it has a guard that is a constant expression ([§15.29](ch15-expressions.md#jls-15.29)) with value `true`; and *guarded* otherwise.
...
- Any local variable, formal parameter, or exception parameter used but not declared in a guard must either be `final` or effectively final ([§4.12.4](ch04-types-values-variables.md#jls-4.12.4)).

- Any blank `final` variable used but not declared in a guard must be definitely assigned ([§16 (Definite Assignment)](ch16-definite-assignment.md)) before the guard.

- A guard cannot be a constant expression ([§15.29](ch15-expressions.md#jls-15.29)) with the value `false`.
...
- If a `null` literal is associated with the switch block, then T is a reference type, or the null type ([§4.1](ch04-types-values-variables.md#jls-4.1)).

- For every `case` constant associated with the switch block that names an enum constant, the type of the `case` constant is assignment compatible with T ([§5.2](ch05-conversions-contexts.md#jls-5.2)).
...
- Every pattern `p` associated with the switch block is applicable at type T ([§14.30.3](ch14-blocks-statements-patterns.md#jls-14.30.3)).
...
- A `case` label with a `case` pattern `q` is dominated if there is a preceding unguarded `case` label in the switch block with a `case` pattern `p`, and `p` dominates `q` ([§14.30.3](ch14-blocks-statements-patterns.md#jls-14.30.3)).
...
- A `default` label or a `case` `null``,` `default` label is dominated if there is a preceding unguarded `case` label in the switch block with a `case` pattern `p` where `p` is unconditional for the type of the selector expression ([§14.30.3](ch14-blocks-statements-patterns.md#jls-14.30.3)).
...
It is a compile-time error if there is a `case` label with *n* (*n*\>1) `case` patterns `p`<sub>`1`</sub>, ..., `p`<sub>`n`</sub> in a switch block where one of the patterns `p`<sub>`i`</sub> (1≤*i*\<*n*) dominates another of the patterns `p`<sub>`j`</sub> (*i*\<*j*≤*n*).
...
It is a compile-time error if, in a switch block that consists of switch labeled statement groups, a statement is labeled with a `case` label that declares one or more pattern variables ([§6.3.3](ch06-names.md#jls-6.3.3)), and either:


- An immediately preceding statement in the switch block can complete normally ([§14.22](ch14-blocks-statements-patterns.md#jls-14.22)), or
...
- P contains a pattern that is unconditional for T ([§14.30.3](ch14-blocks-statements-patterns.md#jls-14.30.3)).

- T is a type variable with upper bound B and P covers B.

- T is an intersection type T<sub>1</sub>`&` ... `&`T<sub>n</sub> and P covers T<sub>i</sub>, for one of the types T<sub>i</sub> (1≤ *i* ≤ *n*).
...
- P rewrites to a set Q and Q covers T.
  ...
  - RP consists of record patterns whose types all erase to the same record class R with *k* (*k*≥1) components and there is a distinguished component `c`<sub>`r`</sub> (1≤*r*≤*k*) of R such that for every other component `c`<sub>`i`</sub> (1≤*i*≤*k*, *i*≠*r*) the set containing the component patterns from the record patterns corresponding to component `c`<sub>`i`</sub> is equivalent to a single pattern `q`<sub>`i`</sub>, the set containing the component patterns from the record patterns corresponding to the component `c`<sub>`r`</sub> reduces to a single pattern `q`, and rp is the record pattern of type R with a pattern list consisting of the patterns `q`<sub>`1`</sub>, ..., `q`<sub>`r-1`</sub>, `q`, `q`<sub>`r+1`</sub>, ..., `q`<sub>`k`</sub>.
    ...
    - EP consists of record patterns whose types all erase to the same record class R with *k* (*k*≥1) components and for every record component the set containing the corresponding component patterns from the record patterns is equivalent to a single pattern `q`<sub>`j`</sub> (1≤*j*≤*k*), and ep is the record pattern of type R with a component pattern list consisting of the component patterns `q`<sub>`1`</sub>,...`q`<sub>`k`</sub>.
...
Both the execution of a `switch` statement ([§14.11.3](ch14-blocks-statements-patterns.md#jls-14.11.3)) and the evaluation of a `switch` expression ([§15.28.2](ch15-expressions.md#jls-15.28.2)) need to determine if a switch label associated with the switch block *applies* to the value of the selector expression. This proceeds as follows:
...
2.  If the value is not the null reference, then we determine the first (if any) `case` label in the switch block that applies to the value as follows:
    ...
    - A `case` label with a `case` constant `c` applies to a value of type `Character`, `Byte`, `Short`, or `Integer`, if the value is first subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)) and the constant `c` is equal to the unboxed value.

      Any unboxing conversion will complete normally as the value being unboxed is guaranteed not to be the null reference.

      Equality is defined in terms of the `==` operator ([§15.21](ch15-expressions.md#jls-15.21)).
    ...
    - Determining that a `case` label with `case` patterns `p`<sub>`1`</sub>, ..., `p`<sub>`n`</sub> (*n*≥1) *applies* to a value proceeds by finding the first (if any) `case` pattern `p`<sub>`i`</sub> (1≤*i*≤*n*) that applies to the value.

      Determining that a `case` pattern applies to a value proceeds first by checking the value matches the pattern ([§14.30.2](ch14-blocks-statements-patterns.md#jls-14.30.2)). Then:
      ...
      - If pattern matching succeeds and the `case` label is guarded, then the guard is evaluated. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
If a `case` label with a `case` pattern applies, then this is because the process of pattern matching the value against the pattern has succeeded ([§14.30.2](ch14-blocks-statements-patterns.md#jls-14.30.2)). If a value successfully matches a pattern then the process of pattern matching initializes any pattern variables declared by the pattern.
...
In addition to the general rules for switch blocks ([§14.11.1](ch14-blocks-statements-patterns.md#jls-14.11.1)), there are further rules for switch blocks in `switch` statements.
...
- Every switch rule expression in the switch block is a statement expression ([§14.8](ch14-blocks-statements-patterns.md#jls-14.8)).

  `switch` statements differ from `switch` expressions in terms of which expressions may appear to the right of an arrow (`->`) in the switch block, that is, which expressions may be used as *switch rule expressions*. In a `switch` statement, only a statement expression may be used as a switch rule expression, but in a `switch` expression, any expression may be used ([§15.28.1](ch15-expressions.md#jls-15.28.1)).

- If the `switch` statement is an enhanced `switch` statement, then it must be exhaustive ([§14.11.1.1](ch14-blocks-statements-patterns.md#jls-14.11.1.1)).
...
If evaluation of the selector expression completes normally, then execution of the `switch` statement continues by determining if a switch label associated with the switch block applies to the value of the selector expression ([§14.11.1.2](ch14-blocks-statements-patterns.md#jls-14.11.1.2)). Then:
...
- If a switch label applies, then one of the following holds:
  ...
  - If it is the switch label for a switch rule expression, then the switch rule expression is necessarily a statement expression ([§14.11.2](ch14-blocks-statements-patterns.md#jls-14.11.2)). The statement expression is evaluated. If the evaluation completes normally, then the `switch` statement completes normally. If the result of evaluation is a value, it is discarded.
...
- If execution of a statement completes abruptly because of a `break` with no label, then no further action is taken and the `switch` statement completes normally.
  ...
  Abrupt completion because of a `break` with a label is handled by the general rule for labeled statements ([§14.7](ch14-blocks-statements-patterns.md#jls-14.7)).
...
- If execution of a statement or expression completes abruptly for any other reason, then the `switch` statement completes abruptly for the same reason.
  ...
  Abrupt completion because of a `yield` statement is handled by the general rule for switch expressions ([§15.28.2](ch15-expressions.md#jls-15.28.2)).
...
A `while` statement is executed by first evaluating the *Expression*. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
- If the value is `true`, then the contained *Statement* is executed. Then there is a choice:
  ...
  - If execution of the *Statement* completes abruptly, see [§14.12.1](ch14-blocks-statements-patterns.md#jls-14.12.1).
...
- If execution of the *Statement* completes abruptly for any other reason, the `while` statement completes abruptly for the same reason.
  ...
  The case of abrupt completion because of a `break` with a label is handled by the general rule for labeled statements ([§14.7](ch14-blocks-statements-patterns.md#jls-14.7)).
...
- If execution of the *Statement* completes normally, then the *Expression* is evaluated. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
- If execution of the *Statement* completes abruptly, see [§14.13.1](ch14-blocks-statements-patterns.md#jls-14.13.1).
...
The scope and shadowing of a local variable declared in the *ForInit* part of a basic `for` statement is specified in [§6.3](ch06-names.md#jls-6.3) and [§6.4](ch06-names.md#jls-6.4).

References to a local variable declared in the *ForInit* part of a basic `for` statement from a nested class or interface, or a lambda expression, are restricted, as specified in [§6.5.6.1](ch06-names.md#jls-6.5.6.1).
...
- If the *ForInit* code is a list of statement expressions ([§14.8](ch14-blocks-statements-patterns.md#jls-14.8)), the expressions are evaluated in sequence from left to right; their values, if any, are discarded.
...
- If the *ForInit* code is a local variable declaration ([§14.4](ch14-blocks-statements-patterns.md#jls-14.4)), it is executed as if it were a local variable declaration statement appearing in a block ([§14.4.2](ch14-blocks-statements-patterns.md#jls-14.4.2)).
...
- If the *Expression* is present, it is evaluated. If the result is of type `Boolean`, it is subjected to unboxing conversion ([§5.1.8](ch05-conversions-contexts.md#jls-5.1.8)).
...
- If the *Expression* is not present, or it is present and the value resulting from its evaluation (including any possible unboxing) is `true`, then the contained *Statement* is executed. Then there is a choice:
  ...
  - If execution of the *Statement* completes abruptly, see [§14.14.1.3](ch14-blocks-statements-patterns.md#jls-14.14.1.3).
...
- If execution of the *Statement* completes abruptly for any other reason, the `for` statement completes abruptly for the same reason.
  ...
  Note that the case of abrupt completion because of a `break` with a label is handled by the general rule for labeled statements ([§14.7](ch14-blocks-statements-patterns.md#jls-14.7)).
...
The following productions from [§4.3](ch04-types-values-variables.md#jls-4.3), [§8.3](ch08-classes.md#jls-8.3), [§8.4.1](ch08-classes.md#jls-8.4.1), and [§14.4](ch14-blocks-statements-patterns.md#jls-14.4) are shown here for convenience:
...
The type of the *Expression* must be an array type ([§10.1](ch10-arrays.md#jls-10.1)) or a subtype of the raw type `Iterable`, or a compile-time error occurs.

The header of the enhanced `for` statement either declares a local variable whose name is the identifier given by *VariableDeclaratorId*, or declares an unnamed local variable ([§6.3](ch06-names.md#jls-6.3)). When the enhanced `for` statement is executed, the local variable is initialized, on each iteration of the loop, to successive elements of the `Iterable` or the array produced by the expression.

The rules for a local variable declared in the header of an enhanced `for` statement are specified in [§14.4](ch14-blocks-statements-patterns.md#jls-14.4), disregarding any rules in that section which apply when the *LocalVariableType* is `var`. In addition, all of the following must be true, or a compile-time error occurs:
...
The scope and shadowing of a local variable declared in the header of an enhanced `for` statement is specified in [§6.3](ch06-names.md#jls-6.3) and [§6.4](ch06-names.md#jls-6.4).

References to the local variable from a nested class or interface, or a lambda expression, are restricted, as specified in [§6.5.6.1](ch06-names.md#jls-6.5.6.1).
...
- If the *LocalVariableType* is *UnannType*, and bracket pairs appear in *UnannType* or *VariableDeclaratorId*, then T is specified by [§10.2](ch10-arrays.md#jls-10.2).
...
- If the *LocalVariableType* is `var`, then let R be derived from the type of the *Expression*, as follows:
  ...
  T is the upward projection of R with respect to all synthetic type variables mentioned by R ([§4.10.5](ch04-types-values-variables.md#jls-4.10.5)).
...
- If the type of *Expression* is a subtype of `Iterable`, then the basic `for` statement has this form:
  ...
  - `#i` is an automatically generated identifier that is distinct from any other identifiers (automatically generated or otherwise) that are in scope ([§6.3](ch06-names.md#jls-6.3)) at the point where the enhanced `for` statement occurs.
  ...
  - If T is a reference type, then *TargetType* is T. Otherwise, *TargetType* is the upper bound of the capture conversion ([§5.1.10](ch05-conversions-contexts.md#jls-5.1.10)) of the type argument of I, or `Object` if I is raw.
...
- Otherwise, the *Expression* necessarily has an array type, S`[]`, and the basic `for` statement has this form:
  ...
  - `L`<sub>`1`</sub> ... `L`<sub>`m`</sub> is the (possibly empty) sequence of labels immediately preceding the enhanced `for` statement.
...
A `break` statement with label *Identifier* attempts to transfer control to the enclosing labeled statement ([§14.7](ch14-blocks-statements-patterns.md#jls-14.7)) that has the same *Identifier* as its label; this enclosing statement, which is called the *break target*, then immediately completes normally. In this case, the break target need not be a `switch`, `while`, `do`, or `for` statement.
...
The preceding descriptions say "attempts to transfer control" rather than just "transfers control" because if there are any `try` statements ([§14.20](ch14-blocks-statements-patterns.md#jls-14.20)) within the break target whose `try` blocks or `catch` clauses contain the `break` statement, then any `finally` clauses of those `try` statements are executed, in order, innermost to outermost, before control is transferred to the break target. Abrupt completion of a `finally` clause can disrupt the transfer of control initiated by a `break` statement.
...
A `continue` statement with label *Identifier* attempts to transfer control to the enclosing labeled statement ([§14.7](ch14-blocks-statements-patterns.md#jls-14.7)) that has the same *Identifier* as its label; this enclosing statement, which is called the *continue target*, then immediately ends the current iteration and begins a new one. In this case, the continue target must be a `while`, `do`, or `for` statement, or a compile-time error occurs.
...
See the descriptions of the `while` statement ([§14.12](ch14-blocks-statements-patterns.md#jls-14.12)), `do` statement ([§14.13](ch14-blocks-statements-patterns.md#jls-14.13)), and `for` statement ([§14.14](ch14-blocks-statements-patterns.md#jls-14.14)) for a discussion of the handling of abrupt termination because of `continue`.

The preceding descriptions say "attempts to transfer control" rather than just "transfers control" because if there are any `try` statements ([§14.20](ch14-blocks-statements-patterns.md#jls-14.20)) within the continue target whose `try` blocks or `catch` clauses contain the `continue` statement, then any `finally` clauses of those `try` statements are executed, in order, innermost to outermost, before control is transferred to the continue target. Abrupt completion of a `finally` clause can disrupt the transfer of control initiated by a `continue` statement.


**Example 14.16-1. The `continue` Statement**


In the `Graph` class in [§14.15](ch14-blocks-statements-patterns.md#jls-14.15), one of the `break` statements is used to finish execution of the entire body of the outermost `for` loop. This break can be replaced by a `continue` if the `for` loop itself is labeled:
...
A `return` statement returns control to the invoker of a method ([§8.4](ch08-classes.md#jls-8.4), [§15.12](ch15-expressions.md#jls-15.12)) or constructor ([§8.8](ch08-classes.md#jls-8.8), [§15.9](ch15-expressions.md#jls-15.9)).
...
It is a compile-time error if the return target of a `return` statement is a constructor, and the `return` statement appears in the prologue of this constructor ([§8.8.7](ch08-classes.md#jls-8.8.7)).
...
It is a compile-time error if the return target of a `return` statement with value *Expression* is a method with declared return type T, and the type of *Expression* is not assignment compatible ([§5.2](ch05-conversions-contexts.md#jls-5.2)) with T.
...
The preceding descriptions say "attempts to transfer control" rather than just "transfers control" because if there are any `try` statements ([§14.20](ch14-blocks-statements-patterns.md#jls-14.20)) within the method or constructor whose `try` blocks or `catch` clauses contain the `return` statement, then any `finally` clauses of those `try` statements will be executed, in order, innermost to outermost, before control is transferred to the invoker of the method or constructor. Abrupt completion of a `finally` clause can disrupt the transfer of control initiated by a `return` statement.


## 14.18. The `throw` Statement


A `throw` statement causes an exception ([§11 (Exceptions)](ch11-exceptions.md)) to be thrown. The result is an immediate transfer of control ([§11.3](ch11-exceptions.md#jls-11.3)) that may exit multiple statements and multiple constructor, instance initializer, static initializer and field initializer evaluations, and method invocations until a `try` statement ([§14.20](ch14-blocks-statements-patterns.md#jls-14.20)) is found that catches the thrown value. If no such `try` statement is found, then execution of the thread ([§17 (Threads and Locks)](ch17-threads-locks.md)) that executed the `throw` is terminated ([§11.3](ch11-exceptions.md#jls-11.3)) after invocation of the `uncaughtException` method for the thread group to which the thread belongs.
...
The *Expression* in a `throw` statement must either denote a variable or value of a reference type which is assignable ([§5.2](ch05-conversions-contexts.md#jls-5.2)) to the type `Throwable`, or denote the null reference, or a compile-time error occurs.

The reference type of the *Expression* will always be a class type (since no interface types are assignable to `Throwable`) which is not parameterized (since a subclass of `Throwable` cannot be generic ([§8.1.2](ch08-classes.md#jls-8.1.2))).

At least one of the following three conditions must be true, or a compile-time error occurs:


- The type of the *Expression* is an unchecked exception class ([§11.1.1](ch11-exceptions.md#jls-11.1.1)) or the null type ([§4.1](ch04-types-values-variables.md#jls-4.1)).

- The `throw` statement is contained in the `try` block of a `try` statement ([§14.20](ch14-blocks-statements-patterns.md#jls-14.20)) and it is not the case that the `try` statement can throw an exception of the type of the *Expression*. (In this case we say the thrown value is *caught* by the `try` statement.)

- The `throw` statement is contained in a method or constructor declaration and the type of the *Expression* is assignable ([§5.2](ch05-conversions-contexts.md#jls-5.2)) to at least one type listed in the `throws` clause ([§8.4.6](ch08-classes.md#jls-8.4.6), [§8.8.5](ch08-classes.md#jls-8.8.5)) of the declaration.


The exception types that a `throw` statement can throw are specified in [§11.2.2](ch11-exceptions.md#jls-11.2.2).
...
If a `throw` statement is contained in a constructor declaration, but its value is not caught by some `try` statement that contains it, then the class instance creation expression that invoked the constructor will complete abruptly because of the `throw` ([§15.9.4](ch15-expressions.md#jls-15.9.4)).

If a `throw` statement is contained in a static initializer ([§8.7](ch08-classes.md#jls-8.7)), then a compile-time check ([§11.2.3](ch11-exceptions.md#jls-11.2.3)) ensures that either its value is always an unchecked exception or its value is always caught by some `try` statement that contains it. If at run time, despite this check, the value is not caught by some `try` statement that contains the `throw` statement, then the value is rethrown if it is an instance of class `Error` or one of its subclasses; otherwise, it is wrapped in an `ExceptionInInitializerError` object, which is then thrown ([§12.4.2](ch12-execution.md#jls-12.4.2)).

If a `throw` statement is contained in an instance initializer ([§8.6](ch08-classes.md#jls-8.6)), then a compile-time check ([§11.2.3](ch11-exceptions.md#jls-11.2.3)) ensures that either its value is always an unchecked exception or its value is always caught by some `try` statement that contains it, or the type of the thrown exception (or one of its superclasses) occurs in the `throws` clause of every constructor of the class.

By convention, user-declared throwable types should usually be declared to be subclasses of class `Exception`, which is a subclass of class `Throwable` ([§11.1.1](ch11-exceptions.md#jls-11.1.1)).


## 14.19. The `synchronized` Statement


A `synchronized` statement acquires a mutual-exclusion lock ([§17.1](ch17-threads-locks.md#jls-17.1)) on behalf of the executing thread, executes a block, then releases the lock. While the executing thread owns the lock, no other thread may acquire the lock.
...
The locks acquired by `synchronized` statements are the same as the locks that are acquired implicitly by `synchronized` methods ([§8.4.3.6](ch08-classes.md#jls-8.4.3.6)). A single thread may acquire a lock more than once.
...
See [§8.3](ch08-classes.md#jls-8.3) for *UnannClassType*. The following productions from [§4.3](ch04-types-values-variables.md#jls-4.3), [§8.3](ch08-classes.md#jls-8.3), and [§8.4.1](ch08-classes.md#jls-8.4.1) are shown here for convenience:
...
The scope and shadowing of an exception parameter is specified in [§6.3](ch06-names.md#jls-6.3) and [§6.4](ch06-names.md#jls-6.4).

References to an exception parameter from a nested class or interface, or a lambda expression, are restricted, as specified in [§6.5.6.1](ch06-names.md#jls-6.5.6.1).
...
It is a compile-time error if a union of types contains two alternatives D<sub>i</sub> and D<sub>j</sub> (*i* ≠ *j*) where D<sub>i</sub> is a subtype of D<sub>j</sub> ([§4.10.2](ch04-types-values-variables.md#jls-4.10.2)).

The declared type of an exception parameter that denotes its type with a single class type is that class type.

The declared type of an exception parameter that denotes its type as a union with alternatives D<sub>1</sub> `|` D<sub>2</sub> `|` ... `|` D<sub>n</sub> is lub(D<sub>1</sub>, D<sub>2</sub>, ..., D<sub>n</sub>).
...
An exception parameter of a uni-`catch` clause is never implicitly declared `final`, but it may be explicitly declared `final` or be effectively final ([§4.12.4](ch04-types-values-variables.md#jls-4.12.4)).
...
The exception types that a `try` statement can throw are specified in [§11.2.2](ch11-exceptions.md#jls-11.2.2).

The relationship of the exceptions thrown by the `try` block of a `try` statement and caught by the `catch` clauses (if any) of the `try` statement is specified in [§11.2.3](ch11-exceptions.md#jls-11.2.3).

Exception handlers are considered in left-to-right order: the earliest possible `catch` clause accepts the exception, receiving as its argument the thrown exception object, as specified in [§11.3](ch11-exceptions.md#jls-11.3).


A multi-`catch` clause can be thought of as a sequence of uni-`catch` clauses. That is, a `catch` clause where the type of the exception parameter is denoted as a union D<sub>1</sub>`|`D<sub>2</sub>`|`...`|`D<sub>n</sub> is equivalent to a sequence of *n* `catch` clauses where the types of the exception parameters are class types D<sub>1</sub>, D<sub>2</sub>, ..., D<sub>n</sub> respectively. In the *Block* of each of the *n* `catch` clauses, the declared type of the exception parameter is lub(D<sub>1</sub>, D<sub>2</sub>, ..., D<sub>n</sub>). For example, the following code:
...
- If execution of the `try` block completes abruptly because of a `throw` of a value `V`, then there is a choice:
  ...
  - If the run-time type of `V` is assignment compatible with ([§5.2](ch05-conversions-contexts.md#jls-5.2)) a catchable exception class of any `catch` clause of the `try` statement, then the first (leftmost) such `catch` clause is selected. The value `V` is assigned to the parameter of the selected `catch` clause, and the *Block* of that `catch` clause is executed, and then there is a choice:
...
See [§8.3](ch08-classes.md#jls-8.3) for *UnannType*.

The *resource specification* denotes the resources of the `try`-with-resources statement, either by declaring local variables with initializer expressions or by referring to existing variables. An existing variable is referred to by an expression name ([§6.5.6](ch06-names.md#jls-6.5.6)) or a field access expression ([§15.11](ch15-expressions.md#jls-15.11)).

The rules for a local variable declared in a resource specification are specified in [§14.4](ch14-blocks-statements-patterns.md#jls-14.4). In addition, all of the following must be true, or a compile-time error occurs:
...
The scope and shadowing of a local variable declared in a resource specification is specified in [§6.3](ch06-names.md#jls-6.3) and [§6.4](ch06-names.md#jls-6.4).

References to the local variable from a nested class or interface, or a lambda expression, are restricted, as specified in [§6.5.6.1](ch06-names.md#jls-6.5.6.1).

The type of a local variable declared in a resource specification is specified in [§14.4.1](ch14-blocks-statements-patterns.md#jls-14.4.1).
...
Note that a resource specification may declare more than one unnamed local variable ([§6.1](ch06-names.md#jls-6.1)).

Resources are `final`, in that:


- A local variable declared in a resource specification is implicitly declared `final` if it is not explicitly declared `final` ([§4.12.4](ch04-types-values-variables.md#jls-4.12.4)).

- An existing variable referred to in a resource specification must be a `final` or effectively `final` variable that is definitely assigned before the `try`-with-resources statement ([§16 (Definite Assignment)](ch16-definite-assignment.md)), or a compile-time error occurs.
...
A `yield` statement transfers control by causing an enclosing `switch` expression ([§15.28](ch15-expressions.md#jls-15.28)) to produce a specified value.
...
It is a compile-time error if the *Expression* of a `yield` statement is void ([§15.1](ch15-expressions.md#jls-15.1)).
...
- A reachable `break` statement *exits a statement* if, within the break target, either there are no `try` statements whose `try` blocks contain the `break` statement, or there are `try` statements whose `try` blocks contain the `break` statement and all `finally` clauses of those `try` statements can complete normally.
  ...
  This definition is based on the logic around "attempts to transfer control" in [§14.15](ch14-blocks-statements-patterns.md#jls-14.15).
...
- An empty block that is not a switch block can complete normally iff it is reachable.
  ...
  A non-empty block that is not a switch block or a constructor body containing a constructor invocation can complete normally iff the last statement in it can complete normally.

  The first statement in a non-empty block that is not a switch block or a constructor body containing a constructor invocation is reachable iff the block is reachable.

  Every other statement `S` in a non-empty block that is not a switch block or a constructor body containing a constructor invocation is reachable iff the statement preceding `S` can complete normally.

- A non-empty block that is the body of a constructor containing a constructor invocation can complete normally iff the last statement in it can complete normally.

  The first statement in a non-empty prologue of a constructor body containing a constructor invocation is reachable iff the block is reachable.

  Every other statement S in the prologue of a constructor body containing a constructor invocation is reachable iff the statement preceding S can complete normally.

  The first statement in a non-empty epilogue of a constructor containing a constructor invocation and an empty prologue is reachable iff the block is reachable.

  The first statement in a non-empty epilogue of a constructor containing a constructor invocation and a non-empty prologue is reachable iff the last statement of the prologue of the constructor can complete normally.

  Every other statement S in the epilogue of a constructor containing a constructor invocation is reachable iff the statement preceding S can complete normally.
...
- A `switch` statement *whose switch block consists of switch labeled statement groups* can complete normally iff at least one of the following is true:
  ...
  - The `switch` statement is not enhanced ([§14.11.2](ch14-blocks-statements-patterns.md#jls-14.11.2)) and its switch block does not contain a `default` label.
...
- A `while` statement can complete normally iff at least one of the following is true:
  ...
  - The `while` statement is reachable and the condition expression is not a constant expression ([§15.29](ch15-expressions.md#jls-15.29)) with value `true`.
...
- A `do` statement can complete normally iff at least one of the following is true:
  ...
  - The contained statement can complete normally and the condition expression is not a constant expression ([§15.29](ch15-expressions.md#jls-15.29)) with value `true`.
...
- A basic `for` statement can complete normally iff at least one of the following is true:
  ...
  - The `for` statement is reachable, there is a condition expression, and the condition expression is not a constant expression ([§15.29](ch15-expressions.md#jls-15.29)) with value `true`.
...
- A `catch` block `C` is reachable iff both of the following are true:
  ...
  - Either the type of `C`'s parameter is an unchecked exception type or `Exception` or a superclass of `Exception`, or some expression or `throw` statement in the `try` block is reachable and can throw a checked exception whose type is assignment compatible ([§5.2](ch05-conversions-contexts.md#jls-5.2)) with the type of `C`'s parameter. (An expression is reachable iff the innermost statement containing it is reachable.)

    See [§15.6](ch15-expressions.md#jls-15.6) for normal and abrupt completion of expressions.
...
Conditional compilation comes with a caveat. If a set of classes that use a "flag" variable - or more precisely, any `static` constant variable ([§4.12.4](ch04-types-values-variables.md#jls-4.12.4)) - are compiled and conditional code is omitted, it does not suffice later to distribute just a new version of the class or interface that contains the definition of the flag. The classes that use the flag will not see its new value, so their behavior may be surprising. In essence, a change to the value of a flag is binary compatible with pre-existing binaries (no `LinkageError` occurs) but not behaviorally compatible.
...
Pattern variables are only in scope ([§6.3](ch06-names.md#jls-6.3)) where pattern matching succeeds and thus the pattern variables will have been initialized. It is not possible to use a pattern variable that has not been initialized.
...
The rules for a local variable declared in a type pattern are specified in [§14.4](ch14-blocks-statements-patterns.md#jls-14.4). In addition, all of the following must be true, or a compile-time error occurs:
...
- If the *LocalVariableType* is `var` then the type pattern must appear directly in the component pattern list of a record pattern, or a compile-time error occurs.
  ...
  Let R be the type of the record pattern, and let T be the type of the corresponding component field in R ([§8.10.3](ch08-classes.md#jls-8.10.3)). The type of the pattern variable is the upward projection of T with respect to all synthetic type variables mentioned by T.
...
A type pattern is said to be *null-matching* if it is appears directly in the component pattern list of a record pattern with type R, where the corresponding record component of R has type U, and the type pattern is unconditional for the type U ([§14.30.3](ch14-blocks-statements-patterns.md#jls-14.30.3)).

Note that this compile-time property of type patterns is used in the run-time process of pattern matching ([§14.30.2](ch14-blocks-statements-patterns.md#jls-14.30.2)), so it is associated with the type pattern for use at run time.

A record pattern consists of a *ReferenceType* and a component pattern list containing component patterns, if any. If *ReferenceType* is not a record class type ([§8.10](ch08-classes.md#jls-8.10)) then a compile-time error occurs.

If the *ReferenceType* is a raw type, then the type of the record pattern is inferred, as described in [§18.5.5](ch18-type-inference.md#jls-18.5.5). It is a compile-time error if no type can be inferred for the record pattern.
...
Let R be the type of the record pattern `r`, and let T be the type of the corresponding component field in R ([§8.10.3](ch08-classes.md#jls-8.10.3)). The type of the match-all pattern is the upward projection of T with respect to all synthetic type variables mentioned by T.
...
*Pattern matching* is the process of testing a value against a pattern at run time. Pattern matching is distinct from statement execution ([§14.1](ch14-blocks-statements-patterns.md#jls-14.1)) and expression evaluation ([§15.1](ch15-expressions.md#jls-15.1)). If a value successfully matches a pattern, then the process of pattern matching will initialize all the pattern variables declared by the pattern, if any.
...
- The null reference *matches* a type pattern if the type pattern is null-matching ([§14.30.1](ch14-blocks-statements-patterns.md#jls-14.30.1)); and *does not match* otherwise.
...
- A value `v` that is not the null reference *matches* a type pattern of type T if `v` can be converted by testing conversion ([§5.7](ch05-conversions-contexts.md#jls-5.7)) to the target type T without raising a `ClassCastException`; and *does not match* otherwise.
...
- A value `v` that is not the null reference *matches* a record pattern with type R and component pattern list `L` if (i) `v` can be converted by testing conversion ([§5.7](ch05-conversions-contexts.md#jls-5.7)) to the target type R without raising a `ClassCastException`; and (ii) each record component of `v` matches the corresponding component pattern in `L`; and *does not match* otherwise.
...
- A type pattern that declares a pattern variable of a reference type U is applicable at a reference type T if there is a testing conversion ([§5.7](ch05-conversions-contexts.md#jls-5.7)) from type T to type U.

- A type pattern that declares a pattern variable of a primitive type P is applicable at the type P.

- A record pattern with type R and pattern list `L` is applicable at type T if (i) there is a testing conversion ([§5.7](ch05-conversions-contexts.md#jls-5.7)) from type T to type R, and (ii) for every component pattern `p` appearing in `L`, if any, `p` is applicable at the type of the corresponding component field in R.
