...
[3.1. Unicode](ch03-lexical-structure.md#jls-3.1)

[3.2. Lexical Translations](ch03-lexical-structure.md#jls-3.2)

[3.3. Unicode Escapes](ch03-lexical-structure.md#jls-3.3)

[3.4. Line Terminators](ch03-lexical-structure.md#jls-3.4)

[3.5. Input Elements and Tokens](ch03-lexical-structure.md#jls-3.5)

[3.6. White Space](ch03-lexical-structure.md#jls-3.6)

[3.7. Comments](ch03-lexical-structure.md#jls-3.7)

[3.8. Identifiers](ch03-lexical-structure.md#jls-3.8)

[3.9. Keywords](ch03-lexical-structure.md#jls-3.9)

[3.10. Literals](ch03-lexical-structure.md#jls-3.10)

[3.10.1. Integer Literals](ch03-lexical-structure.md#jls-3.10.1)

[3.10.2. Floating-Point Literals](ch03-lexical-structure.md#jls-3.10.2)

[3.10.3. Boolean Literals](ch03-lexical-structure.md#jls-3.10.3)

[3.10.4. Character Literals](ch03-lexical-structure.md#jls-3.10.4)

[3.10.5. String Literals](ch03-lexical-structure.md#jls-3.10.5)

[3.10.6. Text Blocks](ch03-lexical-structure.md#jls-3.10.6)

[3.10.7. Escape Sequences](ch03-lexical-structure.md#jls-3.10.7)

[3.10.8. The Null Literal](ch03-lexical-structure.md#jls-3.10.8)

[3.11. Separators](ch03-lexical-structure.md#jls-3.11)

[3.12. Operators](ch03-lexical-structure.md#jls-3.12)


This chapter specifies the lexical structure of the Java programming language.

Programs are written in Unicode ([§3.1](ch03-lexical-structure.md#jls-3.1)), but lexical translations are provided ([§3.2](ch03-lexical-structure.md#jls-3.2)) so that Unicode escapes ([§3.3](ch03-lexical-structure.md#jls-3.3)) can be used to include any Unicode character using only ASCII characters. Line terminators are defined ([§3.4](ch03-lexical-structure.md#jls-3.4)) to support the different conventions of existing host systems while maintaining consistent line numbers.

The Unicode characters resulting from the lexical translations are reduced to a sequence of input elements ([§3.5](ch03-lexical-structure.md#jls-3.5)), which are white space ([§3.6](ch03-lexical-structure.md#jls-3.6)), comments ([§3.7](ch03-lexical-structure.md#jls-3.7)), and tokens. The tokens are the identifiers ([§3.8](ch03-lexical-structure.md#jls-3.8)), keywords ([§3.9](ch03-lexical-structure.md#jls-3.9)), literals ([§3.10](ch03-lexical-structure.md#jls-3.10)), separators ([§3.11](ch03-lexical-structure.md#jls-3.11)), and operators ([§3.12](ch03-lexical-structure.md#jls-3.12)) of the syntactic grammar.


## 3.1. Unicode


Programs are written using the Unicode character set ([§1.7](ch01-introduction.md#jls-1.7)). Information about this character set and its associated character encodings may be found at [<code class="uri">https://www.unicode.org/</code>](https://www.unicode.org/).
...
Except for comments ([§3.7](ch03-lexical-structure.md#jls-3.7)), identifiers ([§3.8](ch03-lexical-structure.md#jls-3.8)), and the contents of character literals, string literals, and text blocks ([§3.10.4](ch03-lexical-structure.md#jls-3.10.4), [§3.10.5](ch03-lexical-structure.md#jls-3.10.5), [§3.10.6](ch03-lexical-structure.md#jls-3.10.6)), all input elements ([§3.5](ch03-lexical-structure.md#jls-3.5)) in a program are formed only from ASCII characters (or Unicode escapes ([§3.3](ch03-lexical-structure.md#jls-3.3)) which result in ASCII characters).
...
1.  A translation of Unicode escapes ([§3.3](ch03-lexical-structure.md#jls-3.3)) in the raw stream of Unicode characters to the corresponding Unicode character. A Unicode escape of the form `\u`*`xxxx`*, where *`xxxx`* is a hexadecimal value, represents the UTF-16 code unit whose encoding is *`xxxx`*. This translation step allows any program to be expressed using only ASCII characters.

2.  A translation of the Unicode stream resulting from step 1 into a stream of input characters and line terminators ([§3.4](ch03-lexical-structure.md#jls-3.4)).

3.  A translation of the stream of input characters and line terminators resulting from step 2 into a sequence of input elements ([§3.5](ch03-lexical-structure.md#jls-3.5)) which, after white space ([§3.6](ch03-lexical-structure.md#jls-3.6)) and comments ([§3.7](ch03-lexical-structure.md#jls-3.7)) are discarded, comprise the tokens that are the terminal symbols of the syntactic grammar ([§2.3](ch02-grammars.md#jls-2.3)).


The longest possible translation is used at each step, even if the result does not ultimately make a correct program while another lexical translation would. There are two exceptions to account for situations that need more granular translation: in step 1, for the processing of contiguous `\` characters ([§3.3](ch03-lexical-structure.md#jls-3.3)), and in step 3, for the processing of contextual keywords and adjacent `>` characters ([§3.5](ch03-lexical-structure.md#jls-3.5)).
...
A compiler for the Java programming language ("Java compiler") first recognizes Unicode escapes in its raw input, translating the ASCII characters `\u` followed by four hexadecimal digits to a *raw input character* which denotes the UTF-16 code unit ([§3.1](ch03-lexical-structure.md#jls-3.1)) for the indicated hexadecimal value. One Unicode escape can represent characters in the range U+0000 to U+FFFF; representing supplementary characters in the range U+010000 to U+10FFFF requires two consecutive Unicode escapes. All other characters in the compiler's raw input are recognized as raw input characters and passed unchanged.
...
[UnicodeEscape](ch03-lexical-structure.md#jls-UnicodeEscape "UnicodeEscape")  
[RawInputCharacter](ch03-lexical-structure.md#jls-RawInputCharacter "RawInputCharacter")


UnicodeEscape:


`\` [UnicodeMarker](ch03-lexical-structure.md#jls-UnicodeMarker "UnicodeMarker") [HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit") [HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit") [HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit") [HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit")
...
Note that `\u005cu005a` cannot be written in a string literal to denote the six characters `\ u 0 0 5 a`. This is because the first two characters resulting from translation, `\` and `u`, are interpreted in a string literal as an illegal escape sequence ([§3.10.7](ch03-lexical-structure.md#jls-3.10.7)).
...
[UnicodeInputCharacter](ch03-lexical-structure.md#jls-UnicodeInputCharacter "UnicodeInputCharacter") but not CR or LF
...
A line terminator specifies the termination of the `//` form of a comment ([§3.7](ch03-lexical-structure.md#jls-3.7)).
...
The input characters and line terminators that result from Unicode escape processing ([§3.3](ch03-lexical-structure.md#jls-3.3)) and then input line recognition ([§3.4](ch03-lexical-structure.md#jls-3.4)) are reduced to a sequence of *input elements*.


Input:


{[InputElement](ch03-lexical-structure.md#jls-InputElement "InputElement")} \[[Sub](ch03-lexical-structure.md#jls-Sub "Sub")\]


InputElement:


[WhiteSpace](ch03-lexical-structure.md#jls-WhiteSpace "WhiteSpace")  
[Comment](ch03-lexical-structure.md#jls-Comment "Comment")  
[Token](ch03-lexical-structure.md#jls-Token "Token")
...
[Keyword](ch03-lexical-structure.md#jls-Keyword "Keyword")  
[Literal](ch03-lexical-structure.md#jls-Literal "Literal")  
[Separator](ch03-lexical-structure.md#jls-Separator "Separator")  
[Operator](ch03-lexical-structure.md#jls-Operator "Operator")
...
Those input elements that are not white space or comments are *tokens*. The tokens are the terminal symbols of the syntactic grammar ([§2.3](ch02-grammars.md#jls-2.3)).

White space ([§3.6](ch03-lexical-structure.md#jls-3.6)) and comments ([§3.7](ch03-lexical-structure.md#jls-3.7)) can serve to separate tokens that, if adjacent, might be tokenized in another manner.

For example, the input characters `-` and `=` can form the operator token `-=` ([§3.12](ch03-lexical-structure.md#jls-3.12)) only if there is no intervening white space or comment. As another example, the ten input characters `staticvoid` form a single identifier token while the eleven input characters `static void` (with an ASCII SP character between `c` and `v`) form a pair of keyword tokens, `static` and `void`, separated by white space.
...
- A sequence of input characters that could be reduced to either an identifier token or a reserved keyword token ([§3.9](ch03-lexical-structure.md#jls-3.9)) is always reduced to a reserved keyword token.

- A sequence of input characters that could be reduced to either a contextual keyword token or to other (non-keyword) tokens is reduced according to context, as specified in [§3.9](ch03-lexical-structure.md#jls-3.9).

- If the input character `>` appears in a type context ([§4.11](ch04-types-values-variables.md#jls-4.11)), that is, as part of a *Type* or an *UnannType* in the syntactic grammar ([§4.1](ch04-types-values-variables.md#jls-4.1), [§8.3](ch08-classes.md#jls-8.3)), it is always reduced to the numerical comparison operator `>`, even when it could be combined with an adjacent `>` character to form a different operator.
...
White space is defined as the ASCII space character, horizontal tab character, form feed character, and line terminator characters ([§3.4](ch03-lexical-structure.md#jls-3.4)).
...
[LineTerminator](ch03-lexical-structure.md#jls-LineTerminator "LineTerminator")
...
[TraditionalComment](ch03-lexical-structure.md#jls-TraditionalComment "TraditionalComment")  
[EndOfLineComment](ch03-lexical-structure.md#jls-EndOfLineComment "EndOfLineComment")


TraditionalComment:


`/` `*` [CommentTail](ch03-lexical-structure.md#jls-CommentTail "CommentTail")


CommentTail:


`*` [CommentTailStar](ch03-lexical-structure.md#jls-CommentTailStar "CommentTailStar")  
[NotStar](ch03-lexical-structure.md#jls-NotStar "NotStar") [CommentTail](ch03-lexical-structure.md#jls-CommentTail "CommentTail")
...
`/`  
`*` [CommentTailStar](ch03-lexical-structure.md#jls-CommentTailStar "CommentTailStar")  
[NotStarNotSlash](ch03-lexical-structure.md#jls-NotStarNotSlash "NotStarNotSlash") [CommentTail](ch03-lexical-structure.md#jls-CommentTail "CommentTail")


NotStar:


[InputCharacter](ch03-lexical-structure.md#jls-InputCharacter "InputCharacter") but not `*`  
[LineTerminator](ch03-lexical-structure.md#jls-LineTerminator "LineTerminator")
...
[InputCharacter](ch03-lexical-structure.md#jls-InputCharacter "InputCharacter") but not `*` or `/`  
[LineTerminator](ch03-lexical-structure.md#jls-LineTerminator "LineTerminator")
...
`/` `/` {[InputCharacter](ch03-lexical-structure.md#jls-InputCharacter "InputCharacter")}
...
The lexical grammar implies that comments do not occur within character literals, string literals, or text blocks ([§3.10.4](ch03-lexical-structure.md#jls-3.10.4), [§3.10.5](ch03-lexical-structure.md#jls-3.10.5), [§3.10.6](ch03-lexical-structure.md#jls-3.10.6)).
...
An identifier never has the same spelling (Unicode character sequence) as a reserved keyword ([§3.9](ch03-lexical-structure.md#jls-3.9)), a boolean literal ([§3.10.3](ch03-lexical-structure.md#jls-3.10.3)) or the null literal ([§3.10.8](ch03-lexical-structure.md#jls-3.10.8)), due to the rules of tokenization ([§3.5](ch03-lexical-structure.md#jls-3.5)). However, an identifier may have the same spelling as a contextual keyword, because the tokenization of a sequence of input characters as an identifier or a contextual keyword depends on where the sequence appears in the program.

To facilitate the recognition of contextual keywords, the syntactic grammar ([§2.3](ch02-grammars.md#jls-2.3)) sometimes disallows certain identifiers by defining a production to accept only a subset of identifiers. The subsets are as follows:
...
*TypeIdentifier* is used in the declaration of classes, interfaces, and type parameters ([§8.1](ch08-classes.md#jls-8.1), [§9.1](ch09-interfaces.md#jls-9.1), [§4.4](ch04-types-values-variables.md#jls-4.4)), and when referring to types ([§6.5](ch06-names.md#jls-6.5)). For example, the name of a class must be a *TypeIdentifier*, so it is illegal to declare a class named `permits`, `record`, `sealed`, `var`, or `yield`.

*UnqualifiedMethodIdentifier* is used when a method invocation expression refers to a method by its simple name ([§6.5.7.1](ch06-names.md#jls-6.5.7.1)). Since the term `yield` is excluded from *UnqualifiedMethodIdentifier*, any invocation of a method named `yield` must be qualified, thus distinguishing the invocation from a `yield` statement ([§14.21](ch14-blocks-statements-patterns.md#jls-14.21)).


## 3.9. Keywords


51 character sequences, formed from ASCII characters, are reserved for use as keywords and cannot be used as identifiers ([§3.8](ch03-lexical-structure.md#jls-3.8)). Another 17 character sequences, also formed from ASCII characters, may be interpreted as keywords or as other tokens, depending on the context in which they appear.


Keyword:


[ReservedKeyword](ch03-lexical-structure.md#jls-ReservedKeyword "ReservedKeyword")  
[ContextualKeyword](ch03-lexical-structure.md#jls-ContextualKeyword "ContextualKeyword")
...
The keyword `_` (underscore) may be used in certain declarations in place of an identifier ([§6.1](ch06-names.md#jls-6.1)).

`true` and `false` are not keywords, but rather boolean literals ([§3.10.3](ch03-lexical-structure.md#jls-3.10.3)).

`null` is not a keyword, but rather the null literal ([§3.10.8](ch03-lexical-structure.md#jls-3.10.8)).

During the reduction of input characters to input elements ([§3.5](ch03-lexical-structure.md#jls-3.5)), a sequence of input characters that notionally matches a contextual keyword is reduced to a contextual keyword if and only if both of the following conditions hold:


1.  The sequence is recognized as a terminal specified in a suitable context of the syntactic grammar ([§2.3](ch02-grammars.md#jls-2.3)), as follows:


    - For `module`, when recognized as a terminal in a *SingleModuleImportDeclaration* ([§7.5.5](ch07-packages-modules.md#jls-7.5.5)), or a *ModuleDeclaration* ([§7.7](ch07-packages-modules.md#jls-7.7)).

    - For `open`, when recognized as a terminal in a *ModuleDeclaration* ([§7.7](ch07-packages-modules.md#jls-7.7)).
    ...
    - For `var`, when recognized as a terminal in a *LocalVariableType* ([§14.4](ch14-blocks-statements-patterns.md#jls-14.4)) or a *LambdaParameterType* ([§15.27.1](ch15-expressions.md#jls-15.27.1)).

      In other contexts, attempting to use `var` as an identifier will cause an error, because `var` is not a *TypeIdentifier* ([§3.8](ch03-lexical-structure.md#jls-3.8)).

    - For `yield`, when recognized as a terminal in a *YieldStatement* ([§14.21](ch14-blocks-statements-patterns.md#jls-14.21)).
    ...
    - For `record`, when recognized as a terminal in a *RecordDeclaration* ([§8.10](ch08-classes.md#jls-8.10)).

    - For `non-sealed`, `permits`, and `sealed`, when recognized as a terminal in a *NormalClassDeclaration* ([§8.1](ch08-classes.md#jls-8.1)) or a *NormalInterfaceDeclaration* ([§9.1](ch09-interfaces.md#jls-9.1)).

    - For `when`, when recognized as a terminal in a *Guard* ([§14.11.1](ch14-blocks-statements-patterns.md#jls-14.11.1)).
...
A *literal* is the source code representation of a value of a primitive type ([§4.2](ch04-types-values-variables.md#jls-4.2)), the `String` type ([§4.3.3](ch04-types-values-variables.md#jls-4.3.3)), or the null type ([§4.1](ch04-types-values-variables.md#jls-4.1)).
...
[DecimalIntegerLiteral](ch03-lexical-structure.md#jls-DecimalIntegerLiteral "DecimalIntegerLiteral")  
[HexIntegerLiteral](ch03-lexical-structure.md#jls-HexIntegerLiteral "HexIntegerLiteral")  
[OctalIntegerLiteral](ch03-lexical-structure.md#jls-OctalIntegerLiteral "OctalIntegerLiteral")  
[BinaryIntegerLiteral](ch03-lexical-structure.md#jls-BinaryIntegerLiteral "BinaryIntegerLiteral")


DecimalIntegerLiteral:


[DecimalNumeral](ch03-lexical-structure.md#jls-DecimalNumeral "DecimalNumeral") \[[IntegerTypeSuffix](ch03-lexical-structure.md#jls-IntegerTypeSuffix "IntegerTypeSuffix")\]


HexIntegerLiteral:


[HexNumeral](ch03-lexical-structure.md#jls-HexNumeral "HexNumeral") \[[IntegerTypeSuffix](ch03-lexical-structure.md#jls-IntegerTypeSuffix "IntegerTypeSuffix")\]


OctalIntegerLiteral:


[OctalNumeral](ch03-lexical-structure.md#jls-OctalNumeral "OctalNumeral") \[[IntegerTypeSuffix](ch03-lexical-structure.md#jls-IntegerTypeSuffix "IntegerTypeSuffix")\]


BinaryIntegerLiteral:


[BinaryNumeral](ch03-lexical-structure.md#jls-BinaryNumeral "BinaryNumeral") \[[IntegerTypeSuffix](ch03-lexical-structure.md#jls-IntegerTypeSuffix "IntegerTypeSuffix")\]
...
An integer literal is of type `long` if it is suffixed with an ASCII letter `L` or `l` (ell); otherwise it is of type `int` ([§4.2.1](ch04-types-values-variables.md#jls-4.2.1)).
...
`0`  
[NonZeroDigit](ch03-lexical-structure.md#jls-NonZeroDigit "NonZeroDigit") \[[Digits](ch03-lexical-structure.md#jls-Digits "Digits")\]  
[NonZeroDigit](ch03-lexical-structure.md#jls-NonZeroDigit "NonZeroDigit") [Underscores](ch03-lexical-structure.md#jls-Underscores "Underscores") [Digits](ch03-lexical-structure.md#jls-Digits "Digits")
...
[Digit](ch03-lexical-structure.md#jls-Digit "Digit")  
[Digit](ch03-lexical-structure.md#jls-Digit "Digit") \[[DigitsAndUnderscores](ch03-lexical-structure.md#jls-DigitsAndUnderscores "DigitsAndUnderscores")\] [Digit](ch03-lexical-structure.md#jls-Digit "Digit")
...
`0`  
[NonZeroDigit](ch03-lexical-structure.md#jls-NonZeroDigit "NonZeroDigit")


DigitsAndUnderscores:


[DigitOrUnderscore](ch03-lexical-structure.md#jls-DigitOrUnderscore "DigitOrUnderscore") {[DigitOrUnderscore](ch03-lexical-structure.md#jls-DigitOrUnderscore "DigitOrUnderscore")}
...
`0` `x` [HexDigits](ch03-lexical-structure.md#jls-HexDigits "HexDigits")  
`0` `X` [HexDigits](ch03-lexical-structure.md#jls-HexDigits "HexDigits")
...
[HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit")  
[HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit") \[[HexDigitsAndUnderscores](ch03-lexical-structure.md#jls-HexDigitsAndUnderscores "HexDigitsAndUnderscores")\] [HexDigit](ch03-lexical-structure.md#jls-HexDigit "HexDigit")
...
[HexDigitOrUnderscore](ch03-lexical-structure.md#jls-HexDigitOrUnderscore "HexDigitOrUnderscore") {[HexDigitOrUnderscore](ch03-lexical-structure.md#jls-HexDigitOrUnderscore "HexDigitOrUnderscore")}
...
The *HexDigit* production above comes from [§3.3](ch03-lexical-structure.md#jls-3.3).
...
`0` [OctalDigits](ch03-lexical-structure.md#jls-OctalDigits "OctalDigits")  
`0` [Underscores](ch03-lexical-structure.md#jls-Underscores "Underscores") [OctalDigits](ch03-lexical-structure.md#jls-OctalDigits "OctalDigits")


OctalDigits:


[OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit")  
[OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit") \[[OctalDigitsAndUnderscores](ch03-lexical-structure.md#jls-OctalDigitsAndUnderscores "OctalDigitsAndUnderscores")\] [OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit")
...
[OctalDigitOrUnderscore](ch03-lexical-structure.md#jls-OctalDigitOrUnderscore "OctalDigitOrUnderscore") {[OctalDigitOrUnderscore](ch03-lexical-structure.md#jls-OctalDigitOrUnderscore "OctalDigitOrUnderscore")}
...
`0` `b` [BinaryDigits](ch03-lexical-structure.md#jls-BinaryDigits "BinaryDigits")  
`0` `B` [BinaryDigits](ch03-lexical-structure.md#jls-BinaryDigits "BinaryDigits")
...
[BinaryDigit](ch03-lexical-structure.md#jls-BinaryDigit "BinaryDigit")  
[BinaryDigit](ch03-lexical-structure.md#jls-BinaryDigit "BinaryDigit") \[[BinaryDigitsAndUnderscores](ch03-lexical-structure.md#jls-BinaryDigitsAndUnderscores "BinaryDigitsAndUnderscores")\] [BinaryDigit](ch03-lexical-structure.md#jls-BinaryDigit "BinaryDigit")
...
[BinaryDigitOrUnderscore](ch03-lexical-structure.md#jls-BinaryDigitOrUnderscore "BinaryDigitOrUnderscore") {[BinaryDigitOrUnderscore](ch03-lexical-structure.md#jls-BinaryDigitOrUnderscore "BinaryDigitOrUnderscore")}
...
The largest decimal literal of type `int` is `2147483648` (2<sup>31</sup>).

All decimal literals from `0` to `2147483647` may appear anywhere an `int` literal may appear. The decimal literal `2147483648` may appear only as the operand of the unary minus operator `-` ([§15.15.4](ch15-expressions.md#jls-15.15.4)).

It is a compile-time error if the decimal literal `2147483648` appears anywhere other than as the operand of the unary minus operator; or if a decimal literal of type `int` is larger than `2147483648` (2<sup>31</sup>).

The largest positive hexadecimal, octal, and binary literals of type `int` - each of which represents the decimal value `2147483647` (2<sup>31</sup>-1) - are respectively:
...
The most negative hexadecimal, octal, and binary literals of type `int` - each of which represents the decimal value `-2147483648` (-2<sup>31</sup>) - are respectively:
...
The largest decimal literal of type `long` is `9223372036854775808L` (2<sup>63</sup>).

All decimal literals from `0L` to `9223372036854775807L` may appear anywhere a `long` literal may appear. The decimal literal `9223372036854775808L` may appear only as the operand of the unary minus operator `-` ([§15.15.4](ch15-expressions.md#jls-15.15.4)).

It is a compile-time error if the decimal literal `9223372036854775808L` appears anywhere other than as the operand of the unary minus operator; or if a decimal literal of type `long` is larger than `9223372036854775808L` (2<sup>63</sup>).

The largest positive hexadecimal, octal, and binary literals of type `long` - each of which represents the decimal value `9223372036854775807L` (2<sup>63</sup>-1) - are respectively:
...
- ` `<sup>`0b0111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111L`</sup>` `


The most negative hexadecimal, octal, and binary literals of type `long` - each of which represents the decimal value `-9223372036854775808L` (-2<sup>63</sup>) - are respectively:
...
- ` `<sup>`0b1000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000_0000L`</sup>` `
...
- ` `<sup>`0b1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111_1111L`</sup>` `
...
[DecimalFloatingPointLiteral](ch03-lexical-structure.md#jls-DecimalFloatingPointLiteral "DecimalFloatingPointLiteral")  
[HexadecimalFloatingPointLiteral](ch03-lexical-structure.md#jls-HexadecimalFloatingPointLiteral "HexadecimalFloatingPointLiteral")


DecimalFloatingPointLiteral:


[Digits](ch03-lexical-structure.md#jls-Digits "Digits") `.` \[[Digits](ch03-lexical-structure.md#jls-Digits "Digits")\] \[[ExponentPart](ch03-lexical-structure.md#jls-ExponentPart "ExponentPart")\] \[[FloatTypeSuffix](ch03-lexical-structure.md#jls-FloatTypeSuffix "FloatTypeSuffix")\]  
`.` [Digits](ch03-lexical-structure.md#jls-Digits "Digits") \[[ExponentPart](ch03-lexical-structure.md#jls-ExponentPart "ExponentPart")\] \[[FloatTypeSuffix](ch03-lexical-structure.md#jls-FloatTypeSuffix "FloatTypeSuffix")\]  
[Digits](ch03-lexical-structure.md#jls-Digits "Digits") [ExponentPart](ch03-lexical-structure.md#jls-ExponentPart "ExponentPart") \[[FloatTypeSuffix](ch03-lexical-structure.md#jls-FloatTypeSuffix "FloatTypeSuffix")\]  
[Digits](ch03-lexical-structure.md#jls-Digits "Digits") \[[ExponentPart](ch03-lexical-structure.md#jls-ExponentPart "ExponentPart")\] [FloatTypeSuffix](ch03-lexical-structure.md#jls-FloatTypeSuffix "FloatTypeSuffix")
...
[ExponentIndicator](ch03-lexical-structure.md#jls-ExponentIndicator "ExponentIndicator") [SignedInteger](ch03-lexical-structure.md#jls-SignedInteger "SignedInteger")
...
\[[Sign](ch03-lexical-structure.md#jls-Sign "Sign")\] [Digits](ch03-lexical-structure.md#jls-Digits "Digits")
...
[HexSignificand](ch03-lexical-structure.md#jls-HexSignificand "HexSignificand") [BinaryExponent](ch03-lexical-structure.md#jls-BinaryExponent "BinaryExponent") \[[FloatTypeSuffix](ch03-lexical-structure.md#jls-FloatTypeSuffix "FloatTypeSuffix")\]


HexSignificand:


[HexNumeral](ch03-lexical-structure.md#jls-HexNumeral "HexNumeral") \[`.`\]  
`0` `x` \[[HexDigits](ch03-lexical-structure.md#jls-HexDigits "HexDigits")\] `.` [HexDigits](ch03-lexical-structure.md#jls-HexDigits "HexDigits")  
`0` `X` \[[HexDigits](ch03-lexical-structure.md#jls-HexDigits "HexDigits")\] `.` [HexDigits](ch03-lexical-structure.md#jls-HexDigits "HexDigits")
...
[BinaryExponentIndicator](ch03-lexical-structure.md#jls-BinaryExponentIndicator "BinaryExponentIndicator") [SignedInteger](ch03-lexical-structure.md#jls-SignedInteger "SignedInteger")
...
The elements of the types `float` and `double` are those values that can be represented using the IEEE 754 binary32 and IEEE 754 binary64 floating-point formats, respectively ([§4.2.3](ch04-types-values-variables.md#jls-4.2.3)).
...
- The largest positive finite `float` value is numerically equal to (2 - 2<sup>-23</sup>) ⋅ 2<sup>127</sup>.
...
- The smallest positive finite non-zero `float` value is numerically equal to 2<sup>-149</sup>.
...
- The largest positive finite `double` value is numerically equal to (2 - 2<sup>-52</sup>) ⋅ 2<sup>1023</sup>.
...
- The smallest positive finite non-zero `double` value is numerically equal to 2<sup>-1074</sup>.
...
A boolean literal is always of type `boolean` ([§4.2.5](ch04-types-values-variables.md#jls-4.2.5)).


### 3.10.4. Character Literals


A *character literal* is expressed as a character or an escape sequence ([§3.10.7](ch03-lexical-structure.md#jls-3.10.7)), enclosed in ASCII single quotes. (The single-quote, or apostrophe, character is `\u0027`.)


CharacterLiteral:


`'` [SingleCharacter](ch03-lexical-structure.md#jls-SingleCharacter "SingleCharacter") `'`  
`'` [EscapeSequence](ch03-lexical-structure.md#jls-EscapeSequence "EscapeSequence") `'`
...
A character literal is always of type `char` ([§4.2.1](ch04-types-values-variables.md#jls-4.2.1)).
...
It is a compile-time error for a line terminator ([§3.4](ch03-lexical-structure.md#jls-3.4)) to appear after the opening `'` and before the closing `'`.
...
The *character represented by a character literal* is the content of the character literal with any escape sequence interpreted, as if by execution of `String.translateEscapes` on the content.

Character literals can only represent UTF-16 code units ([§3.1](ch03-lexical-structure.md#jls-3.1)), i.e., they are limited to values from `\u0000` to `\uffff`. It is a compile-time error to attempt to represent a supplementary character in a character literal. Supplementary characters must be represented either as a surrogate pair within a `char` sequence, or as an integer, depending on the API they are used with.
...
Because Unicode escapes are processed very early, it is not correct to write `'\u000a'` for a character literal whose value is linefeed (LF); the Unicode escape `\u000a` is transformed into an actual linefeed in translation step 1 ([§3.3](ch03-lexical-structure.md#jls-3.3)) and the linefeed becomes a *LineTerminator* in step 2 ([§3.4](ch03-lexical-structure.md#jls-3.4)), so the character literal is not valid in step 3. Instead, one should use the escape sequence `'\n'`. Similarly, it is not correct to write `'\u000d'` for a character literal whose value is carriage return (CR). Instead, use `'\r'`. Finally, it is not possible to write `'\u0027'` for a character literal containing an apostrophe (`'`).
...
A *string literal* consists of zero or more characters enclosed in double quotes. Characters such as newlines may be represented by escape sequences ([§3.10.7](ch03-lexical-structure.md#jls-3.10.7)).


StringLiteral:


`"` {[StringCharacter](ch03-lexical-structure.md#jls-StringCharacter "StringCharacter")} `"`
...
A string literal is always of type `String` ([§4.3.3](ch04-types-values-variables.md#jls-4.3.3)).
...
It is a compile-time error for a line terminator ([§3.4](ch03-lexical-structure.md#jls-3.4)) to appear after the opening `"` and before the matching closing `"`.
...
Because Unicode escapes are processed very early, it is not correct to write `"\u000a"` for a string literal containing a single linefeed (LF); the Unicode escape `\u000a` is transformed into an actual linefeed in translation step 1 ([§3.3](ch03-lexical-structure.md#jls-3.3)) and the linefeed becomes a *LineTerminator* in step 2 ([§3.4](ch03-lexical-structure.md#jls-3.4)), so the string literal is not valid in step 3. Instead, one should use the escape sequence `"\n"`. Similarly, it is not correct to write `"\u000d"` for a string literal containing a single carriage return (CR). Instead, use `"\r"`. Finally, it is not possible to write `"\u0022"` for a string literal containing a double quotation mark (`"`).

A long string literal can always be broken up into shorter pieces and written as a (possibly parenthesized) expression using the string concatenation operator `+` ([§15.18.1](ch15-expressions.md#jls-15.18.1)).

At run time, a string literal is a reference to an instance of class `String` ([§4.3.3](ch04-types-values-variables.md#jls-4.3.3)) that denotes the string represented by the string literal.

Moreover, a string literal always refers to the *same* instance of class `String`. This is because string literals - or, more generally, strings that are the values of constant expressions ([§15.29](ch15-expressions.md#jls-15.29)) - are "interned" so as to share unique instances, as if by execution of the method `String.intern` ([§12.5](ch12-execution.md#jls-12.5)).


**Example 3.10.5-1. String Literals**


The program consisting of the compilation unit ([§7.3](ch07-packages-modules.md#jls-7.3)):
...
- String literals in the same class and package represent references to the same `String` object ([§4.3.1](ch04-types-values-variables.md#jls-4.3.1)).
...
- Strings concatenated from constant expressions ([§15.29](ch15-expressions.md#jls-15.29)) are computed at compile time and then treated as if they were literals.
...
A *text block* consists of zero or more characters enclosed by opening and closing delimiters. Characters may be represented by escape sequences ([§3.10.7](ch03-lexical-structure.md#jls-3.10.7)), but the newline and double quote characters that must be represented with escape sequences in a string literal ([§3.10.5](ch03-lexical-structure.md#jls-3.10.5)) may be represented directly in a text block.


TextBlock:


`"` `"` `"` {[TextBlockWhiteSpace](ch03-lexical-structure.md#jls-TextBlockWhiteSpace "TextBlockWhiteSpace")} [LineTerminator](ch03-lexical-structure.md#jls-LineTerminator "LineTerminator") {[TextBlockCharacter](ch03-lexical-structure.md#jls-TextBlockCharacter "TextBlockCharacter")} `"` `"` `"`


TextBlockWhiteSpace:


[WhiteSpace](ch03-lexical-structure.md#jls-WhiteSpace "WhiteSpace") but not [LineTerminator](ch03-lexical-structure.md#jls-LineTerminator "LineTerminator")
...
The following productions from [§3.3](ch03-lexical-structure.md#jls-3.3), [§3.4](ch03-lexical-structure.md#jls-3.4), and [§3.6](ch03-lexical-structure.md#jls-3.6) are shown here for convenience:
...
A text block is always of type `String` ([§4.3.3](ch04-types-values-variables.md#jls-4.3.3)).
...
Unlike in a string literal ([§3.10.5](ch03-lexical-structure.md#jls-3.10.5)), it is *not* a compile-time error for a line terminator to appear in the content of a text block.
...
If the program is modified to place the closing delimiter on the last line of the content, then an error occurs because the first three consecutive double quote characters on the last line are translated ([§3.2](ch03-lexical-structure.md#jls-3.2)) into the closing delimiter `"""` and thus a stray double quote character remains:
...
Text blocks can be used wherever an expression of type `String` is allowed, such as in string concatenation ([§15.18.1](ch15-expressions.md#jls-15.18.1)), in the invocation of methods on instances of `String`, and in annotations with `String` elements:
...
In character literals, string literals, and text blocks ([§3.10.4](ch03-lexical-structure.md#jls-3.10.4), [§3.10.5](ch03-lexical-structure.md#jls-3.10.5), [§3.10.6](ch03-lexical-structure.md#jls-3.10.6)), the *escape sequences* allow for the representation of some nongraphic characters without using Unicode escapes ([§3.3](ch03-lexical-structure.md#jls-3.3)), as well as the single quote, double quote, and backslash characters.
...
`\` [LineTerminator](ch03-lexical-structure.md#jls-LineTerminator "LineTerminator")  (line continuation, no Unicode representation)  
`\ " `  (double quote `"`, Unicode `\u0022`)  
`\ ' `  (single quote `'`, Unicode `\u0027`)  
`\ \ `  (backslash `\`, Unicode `\u005c`)  
[OctalEscape](ch03-lexical-structure.md#jls-OctalEscape "OctalEscape")  (octal value, Unicode `\u0000` to `\u00ff`)
...
`\` [OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit")  
`\` [OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit") [OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit")  
`\` [ZeroToThree](ch03-lexical-structure.md#jls-ZeroToThree "ZeroToThree") [OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit") [OctalDigit](ch03-lexical-structure.md#jls-OctalDigit "OctalDigit")  
...
The *OctalDigit* production above comes from [§3.10.1](ch03-lexical-structure.md#jls-3.10.1). Octal escapes are provided for compatibility with C, but can express only Unicode values `\u0000` through `\u00FF`, so Unicode escapes are usually preferred.
...
A null literal is always of the null type ([§4.1](ch04-types-values-variables.md#jls-4.1)).
