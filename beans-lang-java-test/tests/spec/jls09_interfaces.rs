...
mod jls_9_1_interface_declarations {
    ...
    fn interface_extends_single() {
        fixture()
            ...
            "#)
            .file("com/example/Channel.java", r#"
                package com.example;
    ...
    fn interface_extends_multiple() {
        fixture()
            ...
            "#)
            .file("com/example/ReadWriteChannel.java", r#"
                package com.example;
    ...
    fn dot_completion_on_shape() {
        fixture()
            ...
            "#)
            .file("com/example/AreaCalc.java", r#"
                package com.example;
...
mod jls_9_2_interface_members {
    ...
    fn own_method_declaration() {
        fixture()
            .file("com/example/EventListener.java", r#"
                package com.example;
                public interface EventListener {
                    void onEvent(String event);
                }
            "#)
            .file("com/example/ClickListener.java", r#"
                package com.example;
    ...
    fn dot_completion_empty_body_interface_shows_inherited_members() {
        fixture()
            .file("com/example/Serializable.java", r#"
                package com.example;
                public interface Serializable {}
            "#)
            .file("com/example/Persistable.java", r#"
                package com.example;
            ...
            .expected_failure("empty-body interface inherited member completion not yet implemented")
            .run();
    }
}
...
mod jls_9_3_interface_constants {
    ...
    fn dot_completion_on_instance_shows_constants() {
        fixture()
            .file("com/example/HttpStatus.java", r#"
                package com.example;
    ...
    fn dot_completion_on_interface_type_shows_static_constants() {
        fixture()
            .file("com/example/Colors.java", r#"
                package com.example;
    ...
    fn dot_completion_shows_inherited_constants() {
        fixture()
            ...
            "#)
            .file("com/example/Extended.java", r#"
                package com.example;
    ...
    fn dot_completion_with_ambiguous_inherited_constants() {
        fixture()
            .file("com/example/A.java", r#"
                package com.example;
                public interface A { int X = 1; }
            "#)
            .file("com/example/B.java", r#"
                package com.example;
                public interface B { int X = 2; }
            "#)
            .file("com/example/C.java", r#"
                package com.example;
            ...
            .expected_failure("ambiguous inherited interface constants not yet handled in completion")
            .run();
    }
    ...
    fn dot_completion_implementing_class_exposes_interface_constants_and_methods() {
        fixture()
            ...
            .expected_failure("interface constants not yet inherited by implementing class in completion")
            .run();
    }
}
...
mod jls_9_4_method_declarations {
    ...
    fn multiple_method_kinds_children() {
        fixture()
            .file("com/example/Collection.java", r#"
                package com.example;
    ...
    fn dot_completion_static_method_via_type_name() {
        fixture()
            ...
            .expected_failure("static method completion via interface type name not yet implemented")
            .run();
    }
    ...
    fn dot_completion_overloaded_methods_in_interface() {
        fixture()
            .file("com/example/PointInterface.java", r#"
                package com.example;
                public interface PointInterface {
                    void move(int dx, int dy);
                }
            "#)
            .file("com/example/RealPointInterface.java", r#"
                package com.example;
    ...
    fn dot_completion_implementing_class_inherits_default_methods() {
        fixture()
            .file("com/example/Greeting.java", r#"
                package com.example;
            ...
            "#)
            .file("com/example/FriendlyBot.java", r#"
                package com.example;
    ...
    fn dot_completion_abstract_redeclared_method_not_duplicated() {
        fixture()
            ...
            "#)
            .file("com/example/Worker.java", r#"
                package com.example;
    ...
    fn dot_completion_conflicting_defaults_resolved_by_override() {
        fixture()
            .file("com/example/Left.java", r#"
                package com.example;
                public interface Left {
                    default String name() { return "left"; }
                }
            "#)
            .file("com/example/Right.java", r#"
                package com.example;
                public interface Right {
                    default String name() { return "right"; }
                }
            "#)
            .file("com/example/Bottom.java", r#"
                package com.example;
    ...
    fn dot_completion_mixed_default_abstract_three_levels() {
        fixture()
            ...
            "#)
            .file("com/example/DomesticCat.java", r#"
                package com.example;
...
mod jls_9_7_annotations {
    ...
    fn method_with_custom_annotation() {
        fixture()
            .file("com/example/Transactional.java", r#"
                package com.example;
                public @interface Transactional {
                    boolean readOnly() default false;
                }
            "#)
            .file("com/example/OrderService.java", r#"
                package com.example;
...
mod jls_9_8_functional_interfaces {
    ...
    fn functional_interface_with_default_methods() {
        fixture()
            .file("com/example/Function.java", r#"
                package com.example;
                @FunctionalInterface
    ...
    fn dot_completion_on_comparator_includes_equals() {
        fixture()
            .file("com/example/Comparator.java", r#"
                package com.example;
                @FunctionalInterface
