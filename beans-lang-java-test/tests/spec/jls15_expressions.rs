...
mod jls_15_12_method_invocation {
    ...
    fn super_method_invocation() {
        fixture()
            ...
            .file(
                "com/example/ChildProcessor.java",
                r#"
                package com.example;
...
mod jls_15_27_lambdas {
    ...
    fn lambda_targeting_functional_interface() {
        fixture()
            ...
            .name("eventType")
            .expected_failure(
                "lambda parameter in functional interface context not yet implemented",
            )
            .run();
    }
...
mod jls_15_12_deeper_completion {
    ...
    fn dot_completion_multiple_interface_methods() {
        fixture()
            ...
            .file(
                "com/example/ReadWriteStream.java",
                r#"
                package com.example;
    ...
    fn dot_completion_after_prior_statement_with_nested_calls() {
        fixture()
            ...
            .expected_failure(
                "variable completion after prior nested-call statement not yet implemented",
            )
            .run();
    }
